...
iPrint_ p ii (Vec a n)        =  iPrint_ p ii (Free defaultPos (Global "Vec") :@: a :@: n)
iPrint_ p ii (List a)        =  iPrint_ p ii (Free defaultPos (Global "List") :@: a )
iPrint_ p ii (VecElim a m mn mc n xs)
                                 =  iPrint_ p ii (Free defaultPos (Global "vecElim") :@: a :@: m :@: mn :@: mc :@: n :@: xs)
-- iPrint_ p ii (Nil a)    = iPrint_ p ii (Free (Global "Nil") :@: a)
-- iPrint_ p ii (Cons a n x xs) =
--                             iPrint_ p ii (Free (Global "Cons") :@: a :@: n :@: x :@: xs)
iPrint_ p ii (Eq a x y)       =  iPrint_ p ii (Free defaultPos (Global "Eq") :@: a :@: x :@: y)
iPrint_ p ii (EqElim a m mr x y eq)
                                 =  iPrint_ p ii (Free defaultPos (Global "eqElim") :@: a :@: m :@: mr :@: x :@: y :@: eq)
iPrint_ p ii (Fin n)          =  iPrint_ p ii (Free defaultPos (Global "Fin") :@: n)
iPrint_ p ii (FinElim m mz ms n f)
                                 =  iPrint_ p ii (Free defaultPos (Global "finElim") :@: m :@: mz :@: ms :@: n :@: f)
...
iPrint_ p ii (TMaybe a) =   iPrint_ p ii (Free defaultPos (Global "Maybe") :@: a)
iPrint_ p ii (LTE l r) =   iPrint_ p ii (Free defaultPos (Global "LTE") :@: l :@: r)
iPrint_ p ii (LTEElim a b c d e f)
                                 =  iPrint_ p ii (Free defaultPos (Global "lteElim") :@: a :@: b :@: c :@: d :@: e :@: f)
...
cPrint_ p ii (Nil a)    = iPrint_ p ii (Free defaultPos (Global "Nil") :@: a)
cPrint_ p ii (LNil a)   = iPrint_ p ii (Free defaultPos (Global "LNil") :@: a)
cPrint_ p ii (Cons a n x xs) =
                             iPrint_ p ii (Free defaultPos (Global "Cons") :@: a :@: n :@: x :@: xs)
cPrint_ p ii (LCons a x xs) =
                             iPrint_ p ii (Free defaultPos (Global "LCons") :@: a :@: x :@: xs)
cPrint_ p ii (Refl a x) = iPrint_ p ii (Free defaultPos (Global "Refl") :@: a :@: x)
cPrint_ p ii (FZero n)  = iPrint_ p ii (Free defaultPos (Global "FZero") :@: n)
cPrint_ p ii (FSucc n f)= iPrint_ p ii (Free defaultPos (Global "FSucc") :@: n :@: f)
cPrint_ p ii (TNothing a) = iPrint_ p ii (Free defaultPos (Global "Nothing") :@: a)
cPrint_ p ii (TJust a b) = iPrint_ p ii (Free defaultPos (Global "Just") :@: a :@: b)

cPrint_ p ii (LTEZero r) = iPrint_ p ii (Free defaultPos (Global "LTEZero") :@: r)
cPrint_ p ii (LTESucc l r lte) = iPrint_ p ii (Free defaultPos (Global "LTESucc") :@: l :@: r :@: lte)
