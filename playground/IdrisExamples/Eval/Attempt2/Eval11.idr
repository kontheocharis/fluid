...
eval [] [] [] (Num n) (NilUZ) = Just n -- why can we not add the ConUZ case as impossible?
eval [] [] [] (Var [] x r) NilUZ = lookupVar [] x [] r
eval (y::ws) (x::vars) ((x,y)::env) (Var (x::vars) x2 r) (ConsUZ u) = lookupVar vars x env r -- this seems to cause difficulty. I think we need to abandon 
                                                                                             -- and pattern match on the elem proof. 
